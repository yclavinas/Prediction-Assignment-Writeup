...
The methods are: Generalized Boosted Mode, Random Forests, Decision Tree and  K-Nearest Neighbour (KNN) as described below. A Confusion Matrix is plotted at the end of each analysis to better visualize the accuracy of the models.
...
## Generalized Boosted Mode, Random Forests and  K-Nearest Neighbour (KNN) 
